        ...
        <AuthCard title="Log In">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col items-center">
                ...
                <div className="flex gap-4 w-full max-w-sm">
                    ...
                    <button
                        type="button"
                        className="flex-1 py-5 bg-white border-2 border-forest/5 rounded-[20px] text-forest font-black text-lg flex items-center justify-center gap-3 hover:bg-gray-50 transition-all shadow-sm"
                ...
                <div className="text-center w-full">
                    <p className="text-forest/40 text-sm font-black uppercase tracking-widest">
                        New seeker?{" "}
                        <Link href="/signup" className="text-forest font-black hover:underline underline-offset-8">Create Account</Link>
                    </p>
                </div>
            </form>
        </AuthCard>
